...
// CompilationDatabase a compilation database holds all information used to compile files in a
...
// FromDirectory creates a compilation database from the database found in directory
