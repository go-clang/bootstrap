...
// IndexSourceFile index the given source file and the translation unit corresponding
...
// IndexTranslationUnit index the given translation unit via callbacks implemented through
// #IndexerCallbacks.
//
