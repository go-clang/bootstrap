...
// GetCompletionChunkText retrieve the text associated with a particular chunk within a
// completion string.
//
// Parameter completion_string the completion string to query.
//
...
// GetCompletionChunkCompletionString retrieve the completion string associated with a particular chunk
...
// GetCompletionAvailability determine the availability of the entity that this code-completion
// string refers to.
//
// Parameter completion_string The completion string to query.
//
...
// GetCompletionNumAnnotations retrieve the number of annotations associated with the given
// completion string.
//
// Parameter completion_string the completion string to query.
//
